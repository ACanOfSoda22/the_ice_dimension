package net.mcreator.fantasmod;
...
import net.mcreator.fantasmod.init.FantasmodModTabs;
...
@Mod("fantasmod")
public class FantasmodMod {
	public static final Logger LOGGER = LogManager.getLogger(FantasmodMod.class);
	public static final String MODID = "fantasmod";

	public FantasmodMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		FantasmodModBlocks.REGISTRY.register(modEventBus);

		FantasmodModItems.register(modEventBus);
		FantasmodModEntities.REGISTRY.register(modEventBus);
		FantasmodModTabs.REGISTRY.register(modEventBus);
